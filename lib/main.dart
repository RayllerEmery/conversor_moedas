...
const _request = "https://api.hgbrasil.com/finance";
...
class _HomeState extends State<Home> {
  ...
  void _realConversion(String text) {
    ...
    dollarController.text = (real * dollar).toStringAsPrecision(3);
                    ...
                    child: Form(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          buildTextField(
                              "Real", "R\$ ", realController, _realConversion),
                          Divider(),
                          buildTextField(
                              "Dollar", "US\$ ", dollarController, _dolarConversion),
                          Divider(),
                          buildTextField(
                              "Euro", "€\$ ", euroController, _euroConversion),
                        ],
                      ),
                    ));
              }
